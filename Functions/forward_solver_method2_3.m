function [Uh, mesh, t_list] = forward_solver_method2_3(h, dt, Nt, afun, pfun, t_1, delta, theta)
% Solves the wave equation with inhomogeneous Absorbing boundary conditions 
% as described in Problem (3). Uses the damped Newmark numerical 
